...
function Popup() {
    ...
    (0, react_2.useEffect)(() => {
        (0, ga_1.postGa)('page_view', { page_title: 'Popup config editor', page_location: '/popup' });
    }, []);
...
function GamepadConfigEditor({ name, onSubmitChanges, onCancelCreate, onActivate, onDelete }) {
    ...
    const handleExport = (0, react_2.useCallback)(() => {
        (0, ga_1.postGa)('btn_click', { name: 'export-config' });
...
function GlobalPrefsEditor({ goBack }) {
    ...
    (0, react_2.useEffect)(() => {
        (0, ga_1.postGa)('page_view', { page_title: 'Global prefs editor', page_location: '/popup/prefs' });
    }, []);
    const handleChange = (0, react_2.useCallback)((e, checked) => {
        const updated = { showControlsOverlay: !!checked };
        (0, ga_1.postGa)('update_prefs', updated);
        dispatch((0, actions_1.updatePrefsAction)(Object.assign(Object.assign({}, prefs), updated)));
    }, [dispatch, prefs]);
...
const getMenuItems = (isPaid, onPay) => [
    ...
    {
        key: 'upgrade',
        text: onPay ? 'Upgraded!' : 'Upgrade',
        style: onPay ? undefined : specialColor,
        disabled: onPay,
        onClick: onPay ? undefined : onPay,
        iconProps: { iconName: 'Diamond', style: onPay ? undefined : specialColor },
    },
    {
        key: 'about',
        text: 'About',
...
function HeaderMoreOptions() {
    ...
    const handlePayClick = (0, react_2.useCallback)(() => {
        (0, ga_1.postGa)('btn_click', { name: 'upgrade-menu-item' });
    ...
    return (react_2.default.createElement("div", { className: "relative" },
        ...
        !payment.paid ? react_2.default.createElement("div", { className: "" }) : null));
}
...
function NewConfigButton({ disabled, allConfigs, onCreate, onImport }) {
    ...
    const handleNewBtnClick = (0, react_1.useCallback)(() => {
        (0, ga_1.postGa)('btn_click', { name: 'open-new-preset-dialog' });
        setIsOpen(!isOpen);
    }, [isOpen]);
    ...
    const handleImport = (0, react_1.useCallback)(() => {
        (0, ga_1.postGa)('btn_click', { name: 'import-preset' });
    ...
    const handleSubmit = (0, react_1.useCallback)(() => {
        (0, ga_1.postGa)('btn_click', { name: 'create-preset' });
        onCreate(name);
    }, [onCreate, name]);
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        isOpen ? (react_1.default.createElement(react_2.Callout, { setInitialFocus: true, gapSpace: 0, directionalHint: react_2.DirectionalHint.bottomRightEdge, target: `#${buttonId}`, onDismiss: handleClose, 
            ...
            react_1.default.createElement("div", { style: { width: 250 }, className: "padding-full" },
                ...
                isTaken ? react_1.default.createElement("div", { className: "error margin-top-s" }, "Preset with that name already exists!") : null,
...
function UpsellModal() {
    ...
    (0, react_2.useEffect)(() => {
        if (show) {
            (0, ga_1.postGa)('page_view', { page_title: 'Upsell modal', page_location: '/popup/upsell' });
        }
    }, [show]);
    const openPaymentPage = (0, react_2.useCallback)(() => {
        (0, ga_1.postGa)('page_view', { page_title: 'Payment page', page_location: '/popup/upsell/payment' });
        (0, ga_1.postGa)('begin_checkout', { currency: 'USD', value: 3.99, items: [{ item_name: 'Full Version' }] });
        doAndThenCloseWindow(extpay.openPaymentPage());
    }, []);
    const openTrialPage = (0, react_2.useCallback)(() => {
        (0, ga_1.postGa)('page_view', { page_title: 'Trial page', page_location: '/popup/upsell/trial' });
        doAndThenCloseWindow(extpay.openTrialPage(`${trial_1.trialDays} day`));
    }, []);
    const openLoginPage = (0, react_2.useCallback)(() => {
        (0, ga_1.postGa)('page_view', { page_title: 'Login page', page_location: '/popup/upsell/login' });
        doAndThenCloseWindow(extpay.openLoginPage());
    }, []);
    const handleClose = (0, react_2.useCallback)(() => __awaiter(this, void 0, void 0, function* () {
        (0, ga_1.postGa)('dismiss', { modal: 'upsell' });
    ...
    return (react_2.default.createElement(react_responsive_modal_1.Modal, { center: true, open: show || isAllowed, onClose: handleClose, showCloseIcon: isAllowed, focusTrapped: true, closeOnEsc: isAllowed },
        react_2.default.createElement(console.log("Pirated by TJVG4M34R13"))));
}
...
const toolkit_1 = __webpack_require__(99639);
const gamepadConfig_1 = __webpack_require__(4053);
...
const selectors_1 = __webpack_require__(83522);
const typed_1 = __webpack_require__(14461);
exports.showUpsellModalAction = (0, toolkit_1.createAction)('upsellModal/show');
exports.fetchGameStatusAction = (0, typed_1.createAppAsyncThunk)('meta/gameStatus', chromeStoredData_1.getLocalGameStatus);
exports.fetchAllAction = (0, typed_1.createAppAsyncThunk)('config/fetchAll', chromeStoredData_1.getAllStoredSync);
exports.fetchPaymentAction = (0, typed_1.createAppAsyncThunk)('payment/fetch', () => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield (0, payments_1.getPayment)();
    return {
        paid: user.paid,
...
function _setActiveConfig(name, state) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        (0, ga_1.postGa)('switch_config', { name });
        return yield (0, messageUtils_1.setActiveConfig)(name, gamepadConfig);
    });
}
exports.activateGamepadConfigAction = (0, typed_1.createAppAsyncThunk)('config/activate', ({ name }, { getState }) => {
    return _setActiveConfig(name, getState());
});
exports.disableGamepadConfigAction = (0, typed_1.createAppAsyncThunk)('config/disable', () => __awaiter(void 0, void 0, void 0, function* () {
    (0, ga_1.postGa)('disable_config');
    yield (0, messageUtils_1.disableActiveConfig)();
}));
exports.deleteGamepadConfigAction = (0, typed_1.createAppAsyncThunk)('config/delete', ({ name }, { getState }) => __awaiter(void 0, void 0, void 0, function* () {
    (0, ga_1.postGa)('modify_config', { name, action: 'delete' });
    const promises = [];
...
exports.modifyGamepadConfigAction = (0, typed_1.createAppAsyncThunk)('config/modify', ({ name, gamepadConfig }, { getState }) => __awaiter(void 0, void 0, void 0, function* () {
    (0, ga_1.postGa)('modify_config', { name, action: 'update' });
    if ((0, selectors_1.isConfigActive)(getState(), name)) {
